...
class _$RemoveUserEventImpl implements RemoveUserEvent {
  const _$RemoveUserEventImpl({required this.id});
  ...
  @override
  String toString() {
    return 'DeleteUserEvent.deleteUser(id: $id)';
  }
...
abstract class RemoveUserEvent implements DeleteUserEvent {
  const factory RemoveUserEvent({required final String id}) =
...
class _$LoadingStateImpl implements _LoadingState {
  ...
  @override
  String toString() {
    return 'DeleteUserState.loading(id: $id)';
  }
...
abstract class _LoadingState implements DeleteUserState {
  const factory _LoadingState({required final String id}) = _$LoadingStateImpl;
...
abstract class _ErrorState implements DeleteUserState {
